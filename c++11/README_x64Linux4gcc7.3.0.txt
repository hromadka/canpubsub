...
data type CanState from canpubsub.idl.
This example builds two applications, named canpubsub_publisher and
canpubsub_subscriber.
...
> make -f makefile_canpubsub_x64Linux4gcc7.3.0
This command will build a release executable.
 
To build a debug version instead:
> make -f makefile_canpubsub_x64Linux4gcc7.3.0 DEBUG=1

To Modify the Data:
===================
To modify the data being sent, edit the canpubsub_publisher.cxx
file where it says:
...
Run /home/gvail/rti_connext_dds-6.1.0/resource/scripts/rtisetenv_x64Linux4gcc7.3.0.bash
...
> objs/x64Linux4gcc7.3.0/canpubsub_publisher -d <domain_id> -s <sample_count>
> objs/x64Linux4gcc7.3.0/canpubsub_subscriber -d <domain_id> -s <sample_count>
